...
\begin{frame}{About Us}
	\begin{columns}
		\begin{column}{0.33\textwidth}
			\includegraphics[width=3cm]{Priyansi}\\
			\center{Priyansi}
			\center{\footnotesize 2\textsuperscript{nd} Year, CSE}\\
		\end{column}
		\begin{column}{0.33\textwidth}
			\includegraphics[width=3cm]{Sejal}
			\center{Sejal Gupta}
			\center{\footnotesize 2\textsuperscript{nd} Year, CSE}\\
		\end{column}
		\begin{column}{0.33\textwidth}
			\includegraphics[width=3cm]{Twisha}
			\center{Twisha Bansal}
			\center{\footnotesize 2\textsuperscript{nd} Year, CSE}\\
		\end{column}
	\end{columns}
	\begin{columns}
		\begin{column}{0.33\textwidth}
			\center{\footnotesize Kalinga Institute of Industrial Technology, Bhubaneshwar}\\
		\end{column}
		\begin{column}{0.33\textwidth}
			\center{\footnotesize Indian Institute of Technology, Goa}\\
		\end{column}
		\begin{column}{0.33\textwidth}
			\center{\footnotesize Indian Institute of Technology, Goa}\\
		\end{column}
